    ...
    <>
      <section className="hero" id="home">
        <div className="container hero-grid">
          <div className="hero-content">
            ...
            <p>
              Помогаю заказать сайт под ключ — от идеи и структуры до запуска.
          ...
          <div className="hero-card">
            ...
            <div className="hero-card-info">
              <span>RKDEV</span>
              <h3>Роман Карпов</h3>
              <p>Программист и frontend-разработчик, который собирает ясные интерфейсы для реальных задач.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section services-section" id="services">
        <div className="container">
          ...
          <p className="section-subtitle">
            Закажите сайт под ключ: выберите подходящий формат — от компактной
            посадочной страницы до точной адаптивной верстки готового дизайна.
            Под каждой услугой расположен соответствующий пример.
          </p>
      ...
      <section className="section about-section" id="about">
        <div className="container">
          ...
          <p className="section-subtitle">
            Я, Роман Карпов, — программист и frontend-разработчик, который работает
            с фронтендом как с инструментом для ясной коммуникации: помогаю упаковать
            услугу, продукт или личный бренд в аккуратный сайт, который легко читать,
            удобно открывать с телефона и просто поддерживать.
          </p>
