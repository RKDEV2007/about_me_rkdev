      ...
      <section className="section section-hero">
        <div className="container">
          ...
          <p className="section-subtitle">
            Лендинги, сайты-визитки и вёрстка для малого бизнеса и личных брендов.
          </p>
        </div>
      </section>
            ...
            {projectsData.map((project) => (
              ...
              >
                <div className="project-card-image-wrap">
                  ...
                  <span className="project-card-overlay">Подробнее</span>
                </div>
          ...
          <div className="modal-body">
            {activeProject && (
              <div className="modal-project">
                ...
                <div className="project-links">
                  <a href={activeProject.demo} target="_blank" rel="noopener" className="btn">Live Demo</a>
                  <a href={activeProject.github} target="_blank" rel="noopener" className="btn btn-secondary">GitHub</a>
                </div>
              </div>
            )}
          </div>
